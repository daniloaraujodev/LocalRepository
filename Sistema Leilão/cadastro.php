...
<h2><center>Cadastro de Produtos Leilão FORA DOA</h2>
<form method="POST"	action="verifica.php">
<pre>
<b><center>Insira as informações dos produtos corretamente</b><br />
<b>Ficha:</b>	        <input type="text" size="35" maxlength="256" name="ficha" placeholder="Digite a ficha do produto">
<b>Artigo:</b>         <input type="text" size="35" maxlength="256" name="artigo" placeholder="Digite o artigo do produto ">
<b>Produto:</b>        <input type="text" size="100" maxlength="256" name="nome" placeholder="Digite o nome do produto">
<b>Situação:</b>       <input type="text" size="100" maxlength="256" name="estado" placeholder="Digite o estado do produto">
<b>Lance Mínimo:</b>   <input type="text" size="100" maxlength="256" name="valor" placeholder="Digite lance mínimo exemplo 100,00">

<input id="button" classe="button" type="submit" value="Efetuar Cadastro" name="enviar">    <input type="reset" value="Limpar Dados" name="Limpar">
 <br />      <b><center>Lista de produtos já cadastrados</b><br />
</pre>
</form>
    <style type="text/css">
...
<!--criando tabela php para saida de dados-->
...
$strcon = mysqli_connect($Servidor, $Usuario, $Senha, $nomeBanco); 
 ...
 $sql = "SELECT * FROM produtos ORDER BY nome, ficha";
 ...
 while ($registro = mysqli_fetch_array($resultado))
 {
   ...
   echo "<tr>";
   echo "<td>".$ficha."</center></td>";
   echo "<td>".$artigo."</center></td>";
   echo "<td>".$nome."</center></td>";
   echo "<td>".$estado."</center></td>";
   echo "<td>R$ ".$valor."</center></td>";
